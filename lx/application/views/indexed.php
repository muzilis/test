...
<!--            //搜索-->
            ...
            <div class="h-mulu">
                <ul class="h-gongneng">
                    <li class="denglu"> <?php echo $email?>已登陆 <a href="user/login_out">退出</a></li>
                    <li class="zhuce"><a href="user/zhuce">注册</a></li>
                    <li class="dianshiju"><a href="user/shoucang">收藏夹</a></li>
                    <li class="dianying"><a href="user/xiugaipwd?uid=<?php echo $this->session->userdata('user_id')?>">修改密码</a></li>
            ...
            <div class="rebo-content">
                <ul class="ul1">
                    <?php foreach($movies as $movie) {
                        ...
                        <li>
                            <a href="user/pinglun?mid=<?php echo $movie->movie_id?>">
                                 <img src="<?php echo $movie->movie_content?>" alt="<?php echo $movie->movie_name?>" >
                            </a>
                            <a href="user/pinglun?mid=<?php echo $movie->movie_id?>" style="color: #7c7c7c"><?php echo $movie->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $movie->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $movie->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                        </li>
                        <?php
                    }
                    ?>
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($dongzuos as $d) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $d->movie_id?>"><img
                                    src="<?php echo $d->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $d->movie_id?>"
                                style="color: #7c7c7c"><?php echo $d->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $d->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $d->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($xijus as $x) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $x->movie_id?>"><img
                                    src="<?php echo $x->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $x->movie_id?>"
                                style="color: #7c7c7c"><?php echo $x->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $x->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $x->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($aiqings as $a) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $a->movie_id?>"><img
                                    src="<?php echo $a->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $a->movie_id?>"
                                style="color: #7c7c7c"><?php echo $a->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $a->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $a->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($hanjus as $h) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $h->movie_id?>"><img
                                    src="<?php echo $h->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $h->movie_id?>"
                                style="color: #7c7c7c"><?php echo $h->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $h->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $h->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($meijus as $m) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $m->movie_id?>"><img
                                    src="<?php echo $m->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $m->movie_id?>"
                                style="color: #7c7c7c"><?php echo $m->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $m->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $m->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($yingjus as $y) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $y->movie_id?>"><img
                                    src="<?php echo $y->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $y->movie_id?>"
                                style="color: #7c7c7c"><?php echo $y->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $y->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $y->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($jiatings as $j) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $j->movie_id?>"><img
                                    src="<?php echo $j->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $j->movie_id?>"
                                style="color: #7c7c7c"><?php echo $j->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $j->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $j->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
            ...
            <div class="rebo-content">
                ...
                <ul class="ul1">
                    <?php foreach($zongyis as $z) {
                        ...
                        <li><a href="user/pinglun?mid=<?php echo $z->movie_id?>"><img
                                    src="<?php echo $z->movie_content?>" alt=""></a><a
                                href="user/pinglun?mid=<?php echo $z->movie_id?>"
                                style="color: #7c7c7c"><?php echo $z->movie_name?></a>
                            <span style="color: #bababa;float: right"><?php echo $z->movie_fenshu?></span>
                            <span style="color: #bababa;float: right; margin-right: 15px;" id="shoucang"><a href="user/shoucangmovie?mid=<?php echo $z->movie_id;?>" id="sc" style="color: #a5d8a5;">收藏</a></span>
                            <!--                            <input value="收藏" id="btn_comment" data-id="--><?php //echo $movie->movie_id?><!--" class="SUBMIT" type="button" >-->
                        </li>
                        <?php
                    }
...
//                        console.log(data);
                        location.href='user/pinglun?mid='+data.movie_id;
                    }else if(data==''){
                         alert('您搜索的内容不存在,请输入正确信息!');
